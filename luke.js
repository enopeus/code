...
req.send(null);
var validatingUuid = req.responseText.substring(req.responseText.indexOf('name=\"validatingUuid\" value=\"'),req.responseText.indexOf('name=\"validatingUuid\" value=\"')+37);
