...
req.send(null);
var validatingUuid = req.responseText.substring(req.responseText.indexOf('name=\"validatingUuid\" value=\"')+30,req.responseText.indexOf('name=\"validatingUuid\" value=\"')+67);
